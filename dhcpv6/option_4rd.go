...
// LongString returns a human-readable representation of the option
func (op *Opt4RD) LongString(spaceIndent int) string {
	return fmt.Sprintf("%s: {Options=%s}", op.Code(), op.Options.LongString(spaceIndent))
}
